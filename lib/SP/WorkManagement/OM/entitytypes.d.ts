...
**********************************************/
export interface LocationOrientedSortableSessionOData extends SP.WorkManagement.OM.BaseSessionOData, Base.IBaseResult, LocationOrientedSortableSessionProps, LocationOrientedSortableSessionMethods {
...
**********************************************/
export interface LocationOrientedUserOrderedSessionOData extends SP.WorkManagement.OM.BaseSessionOData, Base.IBaseResult, LocationOrientedUserOrderedSessionProps, LocationOrientedUserOrderedSessionMethods {
...
**********************************************/
export interface SortableSessionOData extends SP.WorkManagement.OM.BaseSessionOData, Base.IBaseResult, SortableSessionProps, SortableSessionMethods {
...
**********************************************/
export interface UserOrderedSessionOData extends SP.WorkManagement.OM.BaseSessionOData, Base.IBaseResult, UserOrderedSessionProps, UserOrderedSessionMethods {
