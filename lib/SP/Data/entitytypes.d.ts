...
/*********************************************
* OData__x005f_catalogs_x002f_hubsiteItem
**********************************************/
export interface OData__x005f_catalogs_x002f_hubsiteItem {
	ID?: number;
	...
	ExtractedMetadataComputed?: string;
	MainLinkSettings?: string;
	AppAuthorId?: number;
	AppEditorId?: number;
	SelectTitle?: string;
...
/*********************************************
* OData__x005f_catalogs_x002f_hubsiteItemCollections
**********************************************/
export interface OData__x005f_catalogs_x002f_hubsiteItemCollections {

}

/*********************************************
* OData__x005f_catalogs_x002f_hubsiteItemOData
**********************************************/
export interface OData__x005f_catalogs_x002f_hubsiteItemOData extends Base.IBaseResult, OData__x005f_catalogs_x002f_hubsiteItem {
...
/*********************************************
* CSPViolationReportListListItem
**********************************************/
export interface CSPViolationReportListListItem {
	ContentTypeId?: string;
	Title?: string;
	OData__ModerationComments?: string;
	File_x0020_Type?: string;
...
/*********************************************
* CSPViolationReportListListItemCollections
**********************************************/
export interface CSPViolationReportListListItemCollections {

}

/*********************************************
* CSPViolationReportListListItemOData
**********************************************/
export interface CSPViolationReportListListItemOData extends Base.IBaseResult, CSPViolationReportListListItem {
	Author: SP.Data.UserInfoItem & SP.Data.UserInfoItemCollections;
	Editor: SP.Data.UserInfoItem & SP.Data.UserInfoItemCollections;
}
...
* DevListItemOData
**********************************************/
export interface DevListItemOData extends Base.IBaseResult, DevListItem {
	Author: SP.Data.UserInfoItem & SP.Data.UserInfoItemCollections;
	Editor: SP.Data.UserInfoItem & SP.Data.UserInfoItemCollections;
}
