...
export interface ActivityLoggerMethods {
	...
	logActivity(Operation?: string, ListId?: any, ListItemUniqueId?: any, AffectedResourceUrl?: string, ItemType?: string, ExtraProperties?: Microsoft.SharePoint.Internal.LogActivityExtraProperties, AuditCreationTime?: string, IsOffline?: boolean, UserIdList?: Array<string>): Base.IBaseExecution<any>;
	logActivityBulk(Operation?: string, SiteId?: any, WebId?: any, ListId?: any, MailboxType?: string, Requests?: Array<Microsoft.SharePoint.Internal.LogActivityRequest>): Base.IBaseExecution<any>;
}
